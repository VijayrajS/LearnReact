        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "div",
                    null,
                    this.props.optionList.map(function (element, index) {
                        return React.createElement(Option, { key: index, data: element });
                    })
                ),
...
var AddOption = function (_React$Component6) {
    ...
    _createClass(AddOption, [{
        ...
        value: function submitForm(e) {
            e.preventDefault();
            var option = e.target.elements.form_option.value;
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement("input", { type: "text", name: "form_option" }),
                React.createElement(
                    "button",
                    null,
                    "Add option"
